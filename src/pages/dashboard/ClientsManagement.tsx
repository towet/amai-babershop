...
const ClientsManagement = () => {
  ...
  const filteredClients = clients.filter(client => {
    ...
    const sanitizedSearchTerm = lowercasedSearchTerm.replace(/\D/g, '');
    ...
    const phoneMatch = client.phone && sanitizedSearchTerm && client.phone.replace(/\D/g, '').includes(sanitizedSearchTerm);
