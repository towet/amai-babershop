        ...
        {isLoading ? (
          ...
          >
            <motion.div
              ...
              className="relative"
            >
              <div className="font-['Bebas_Neue'] text-6xl tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-500 to-orange-500 relative z-10 transform -rotate-2 pr-1">
                AMAI
              </div>
