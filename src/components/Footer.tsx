          ...
          <div className="space-y-6">
            <div className="flex flex-col items-start">
              <div className="flex items-center">
                <div 
                  className="font-['Bebas_Neue'] text-3xl md:text-4xl tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-amber-500 to-orange-500 relative z-10 transform -rotate-2 pr-1"
